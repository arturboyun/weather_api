...
from weather_api.db.utils import create_database, drop_database
from weather_api.services.rabbit.dependencies import get_rmq_channel_pool
from weather_api.services.rabbit.lifespan import init_rabbit, shutdown_rabbit
from weather_api.services.redis.dependency import get_redis_pool
from weather_api.settings import settings
from weather_api.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    from weather_api.db.models import load_all_models
